package com.innovatech.tareas_service.adapter;
...
import com.innovatech.tareas_service.exception.ServicioExternoException;
    ...
    public ProyectoAdaptadoResponse fallbackObtenerProyecto(Long idProyecto, Throwable error) {
        throw new ServicioExternoException(
                "No fue posible validar el proyecto con ID: " + idProyecto +
                        ". El servicio de proyectos no está disponible o el proyecto no existe."
        );
    }
}